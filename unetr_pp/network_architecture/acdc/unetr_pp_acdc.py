...
class UNETR_PP(SegmentationNetwork):
    ...
    def __init__(
        ...
        self.feat_size = (depth // 8, window_size // 32, window_size // 32)
        self.hidden_size = hidden_size

        self.unetr_pp_encoder = UnetrPPEncoder(dims=dims, depths=depths, num_heads=num_heads, window_size=window_size, depth=depth)
        ...
        self.decoder5 = UnetrUpBlock(
            ...
            norm_name=norm_name,
            out_size=(depth // 4) * (window_size // 16) ** 2,
        )
        self.decoder4 = UnetrUpBlock(
            ...
            upsample_kernel_size=2,
            norm_name=norm_name,
            out_size=(depth // 2) * (window_size // 8) ** 2,
        )
        self.decoder3 = UnetrUpBlock(
            ...
            upsample_kernel_size=2,
            norm_name=norm_name,
            out_size=depth * (window_size // 4) ** 2,
        )
        self.decoder2 = UnetrUpBlock(
            ...
            norm_name=norm_name,
            out_size=depth * (window_size // 2) ** 2,
            conv_decoder=True,
        )
